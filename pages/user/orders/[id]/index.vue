<template>
  <div class="xl:h-screen overflow-y-auto px-4 py-8 ">
    <NuxtLink to="/user/orders">
      <div class="flex gap-4 items-center">
        ...
        <p class="text-gray-600">Order / <span class="text-xs text-[primary]">{{ route.params.id }}</span></p>
      </div>
    </NuxtLink>
<div class="flex gap-4 w-full flex-col xl:flex-row md:flex-row">
  <div class="flex flex-col xl:w-[800px]  gap-4 mt-8">
    ...
    :key="index"
      ...
      >
        ...
        >
          <p class="text-md font-bold">${{ product.total }}</p>
      ...
      <div class=" flex flex-col gap-4 xl:flex-grow ">
        ...
        <div class="flex justify-between py-2 border-[#f2f2f2] border-t-[1px]">
          <span>Total</span>
